<div>
    ...
    @endif
    @if($montoMinimoNoPermitidoYCuotasNoPermitidas)
        ...
        <p class="mt-2">Las cuotas
            <span class="{{$classesSpan}}">
                no pueden ser superiores a {{$this->limiteCuotasQuitaConDescuento}}
            </span>
        </p>
        <button class="bg-red-600 mt-2 w-full text-white rounded hover:bg-red-700 p-2" wire:click="cancelarPropuesta">
            Recalcular
        </button>
    @elseif($montoMinimoPermitidoYCuotasNoPermitidas)
        <h3 class="{{$classesTitulo}}">No se cumplen cumple con las políticas</h3>
        <p class="mt-2">Las cuotas
            <span class="{{$classesSpan}}">
                no pueden ser superiores a {{$this->limiteCuotasQuitaConDescuento}}
    ...
    @elseif($montoMinimoNoPermitidoYCuotasPermitidas)
        <h3 class="{{$classesTitulo}}">No se cumplen cumple con las políticas</h3>
    ...
    @elseif($montoMinimoPermitidoYCuotasPermitidas)
