<div>
    <button
        class="bg-blue-800 text-white w-28 h-10 rounded mb-2"
        wire:click="modalNuevoTelefono"
    > + Telefóno 
    </button>
    @if($modalNuevoTelefono)
        <form 
            class="container p-4 mt-3 border text-sm"
            wire:submit.prevent='nuevoTelefono'
            >
            <h2 class="text-center bg-gray-200 py-2 mb-4 font-bold uppercase">Nuevo teléfono</h2>
                ...
                <div class="flex gap-2 mt-4">
                    ...
                    <button class="p-2 w-full justify-center bg-red-600 hover:bg-red-800 text-white"
                        wire:click="cerrarModalNuevoTelefono">
                            Cancelar
                    </button>
                </div>
        </form>
