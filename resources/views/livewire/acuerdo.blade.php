        ...
        <div class="fixed top-0 left-0 right-0 bottom-0 flex justify-center items-center z-50 bg-gray-900 bg-opacity-50">
            <div class="flex flex-col items-center bg-gray-100 p-4 rounded-md">
                ...
                <div>
                    ...
                    <p class="font-bold text-gray-800 text-center">Estás a punto de importar <span class="font-extrabold uppercase text-red-600">Acuerdos de Pago.</span></p>
                    ...
                    <p class="text-sm text-gray-600">2- No deben existir acuerdos vigentes para las propuestas que estas importando.</p>
                    <p class="text-sm text-gray-600">3- Durante la importación se generarán los acuerdos, sus PDF y sus respectivos pagos.</p>
