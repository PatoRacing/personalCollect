<div class=" bg-gray-200 pt-4">
    <form wire:submit.prevent="leerTerminoBusqueda" class="flex justify-center gap-4">
        <div class="mb-5">
            <label 
        ...
        <div class="mb-5">
            <label class="block mb-1 text-sm text-gray-700 uppercase font-bold">Situación:</label>
