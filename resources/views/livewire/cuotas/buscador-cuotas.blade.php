<form wire:submit.prevent="busquedaDeCuotas"
    ...
    <div class="grid grid-cols-1 justify-center md:grid-cols-2 lg:grid-cols-6 gap-2">
        ...
        <!--Mes-->
        <div>
            <label class="block mb-1 font-bold"" for="mes">Mes:</label>
        ...
        <div>
            ...
            <select wire:model="estado" class="text-sm border-gray-300 pr-20 text-gray-600 w-full rounded-md shadow-sm">
                <option>Seleccione</option>
    ...
    <div class="mt-2 grid grid-cols-2 md:grid-cols-6 justify-center gap-2">
        ...
        <button 
            type="button"
            class="text-white py-2 rounded text-sm bg-red-600 hover:bg-red-700 md:col-span-1"
