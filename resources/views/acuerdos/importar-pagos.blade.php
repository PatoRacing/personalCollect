    ...
    <div class="container mx-auto ">
        <div class="overflow-x-auto">
            <div class="p-4 sticky left-0">
                <h1 class="font-extrabold text-2xl bg-white p-4 text-gray-900 text-center mb-5">Importar Pagos</h1>
            ...
            <livewire:modal-importar-pagos />

            <form 
                class="container p-2"
                method="POST"
                action="{{route('almacenar.pagos')}}"
