...
class BotonesDeGestionesDePago extends Component
{
    ...
    //Obtiene el pagoDeCuota actual y carga la variable acciones para que llame a la funcion y pasa el pagodecuoa y rol
    ...
    {
        $estadoDeCuota = $pagoDeCuota->pago->estado;
        $acciones = [
        ...
        $accionesFiltradas = array_filter($acciones[$rol][$pagoDeCuota->situacion], function ($accion) use ($estadoDeCuota) {
    ...
    {
        return view('livewire.gestiones.botones-de-gestiones-de-pago',[
