...
class PagosIncumplidos extends Component
{
    public $nro_doc;
    public $nro_operacion;
    public $deudor;
    protected $listeners = ['busquedaPagosIncumplidos'=>'buscarPagoIncumplido'];

    public function buscarPagoIncumplido($nro_doc, $nro_operacion, $deudor)
    {
    ...
    public function render()
    {
        ...
        $pagosIncumplidos = $query->paginate(30);

        return view('livewire.pagos-incumplidos', [
            'pagosIncumplidos' => $pagosIncumplidos
        ]);
    }
}
