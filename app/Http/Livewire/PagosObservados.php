...
class PagosObservados extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        $pagosObservados = $query->paginate(30);

        $pagosObservadosTotales = $pagosObservados->total();

        return view('livewire.pagos.pagos-observados',[
            'pagosObservados'=>$pagosObservados,
            'pagosObservadosTotales'=>$pagosObservadosTotales,
        ]);
    }
}
